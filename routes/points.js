...
console.log('[Points Router] 初始化 points.js 路由, 版本: 2024011607');
...
console.log('[Points Router] 验证处理函数:', {
    updatePoints: typeof handlers.updatePoints === 'function',
    getBalance: typeof handlers.getBalance === 'function'
});
